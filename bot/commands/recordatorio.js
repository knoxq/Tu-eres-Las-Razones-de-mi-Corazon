...
export function execute(message, client) {
  ...
  if (reminders.has(from)) {
    return message.reply('⏰ Ya tienes un recordatorio programado. Te avisaré el 1 de julio cuando el libro esté disponible 💖');
  }

  const releaseDate = new Date('2026-07-01T00:00:00-06:00');
...
Te avisaré el *1 de julio* cuando el libro esté disponible (faltan ${days} días).
